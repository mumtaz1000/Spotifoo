...
public class Display {
    ...
    protected static List<String> songsMenuDisplayOption(){
        ...
        songFile = Songs.songDetails(songObj.songsAll,4);
        List<String> songImg;
        songImg = Songs.songDetails(songObj.songsAll, 5);
        return Songs.getSongToPlay(songObj.songsNames,songFile,songImg);
    }
    ...
    protected static void displayIndividualArtistOrAlbumOrGenreName(int option, String displayOption){
        ...
        requiredList = Songs.songDetails(songObj.songsAll,option);
        Collections.sort(requiredList);
        List<String> genreList;
        genreList = Songs.displayArtistsOrAlbumsOrGenre(requiredList);
        System.out.println("Choose the "+displayOption+" ");
        //Taking input from user
        Songs.takingArtistOrAlbumNameOrGenreAsUserInput(genreList);
    }
